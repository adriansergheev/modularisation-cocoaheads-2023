...
public final class ScrumTimer: ObservableObject {
     ...
     */
    public init(lengthInMinutes: Int = 0, attendees: [DailyScrum.Attendee] = []) {
    ...
    public nonisolated func skipSpeaker() {
        Task { @MainActor in
     ...
     */
    public func reset(lengthInMinutes: Int, attendees: [DailyScrum.Attendee]) {
        self.lengthInMinutes = lengthInMinutes
        self.speakers = attendees.speakers
        secondsRemaining = lengthInSeconds
        activeSpeaker = speakerText
...
extension Array<DailyScrum.Attendee> {
    public var speakers: [ScrumTimer.Speaker] {
        if isEmpty {
